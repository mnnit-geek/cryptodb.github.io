! function() {
  ...
  n.embedWidgetSitePath.get = function() {
    ...
    if (l ? (this.script.parentNode.replaceChild(this.iframe, l), this.script.parentNode.removeChild(this.script)) : (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.replaceChild(this.iframeContainer, this.script)), h) {
      ...
      g.style.height = "32px", g.style.lineHeight = "32px", g.style.width = s, g.style.textAlign = "center", g.style.verticalAlign = "middle", g.innerHTML = c.innerHTML, this.iframeContainer.appendChild(g)
    }
  }, r.prototype._iframeSrcBase = function(t, e) {
    var i = "https://s.tradingview.com";
    return "local" === e ? i = "http://" + t : "staging" === e && (i = -1 !== t.indexOf("beta.tradingview.com") ? "https://betacdn.tradingview.com" : "https://" + t), this.settings.customer && -1 !== this.propertiesToSkipInHash.indexOf("customer") && (i += "/" + this.settings.customer), i + this.embedWidgetSitePath
  ...
  }, Object.defineProperties(r.prototype, n), new(function(e) {
    function i() {
    ...
    return r.widgetName.get = function() {
      return "technical_analysis"
    }, r.embedWidgetSitePath.get = function() {
      return "/technical-analysis-widget-embed/"
    }, r.defaultSettings.get = function() {
      return t
    }, r.propertiesToWorkWith.get = function() {
      return ["height", "interval", "locale", "symbol", "whitelabel", "width", "largeChartUrl"]
    }, i.prototype._createIframeWrap = function() {
