    ...
    var i = function(t) {
      ...
      n = function(t, i) {
        this._template = "", this._data = {}, this.fnItemsTemplatePrepare = function() {}, this.container = t, this._defaults = {
          ...
          coins: ["BTC", "ETH"],
          currency: "USD"
        }, this.options = e.extend({}, this._defaults, i), this.template = '<div class="ct-widget-container"><div class="ct-widget"><div class="ct-widget__body" {bodyAttr}><div class="ct-widget__posts">{news}</div></div><div class="ct-widget__footer">{footer}</div></div></div>', this.arWidgetClassMap = {
    ...
    var r = function(i, n) {
      this.container = i || null, this.apiNewsUrl = "https://api.cointelegraph.com/api/v1", this.apiNewsMethod = "/ext-news", this._default = {
        ...
        widgetConfig: {
          ...
          selflink: !1,
          footerColor: "",
          height: 500 // Parameter to control widget height
        },
        newsParams: {
          limit: 5
        }
